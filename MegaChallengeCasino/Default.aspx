...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Image ID="firstReelImage" runat="server" Height="150px" Width="150px" />
            <asp:Image ID="secondReelImage" runat="server" Height="150px" Width="150px" />
            <asp:Image ID="thirdReelImage" runat="server" Height="150px" Width="150px" />
            <br />
            <br />
